...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         */
        System.out.println("\nInput header names and type in the format 'header name--type', where type is [numeric, string, date, category, class] (type 'stop' when you are done):");
        System.out.println("\nIMPORTANT: Make sure the column you wish to classify on is of type class!");
